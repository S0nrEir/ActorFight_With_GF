...
namespace UGFExtensions.Await
{
    public static class AwaitableExtension
    {
            ...
            EntityData data)
        {
            ...
            entityComponent.ShowEntity(data.Id,logicType, data.ModelPath, "Async",priority, data);
            return tcs.Task;
        }
        ...
        /// 显示实体（可等待）
        /// </summary>
        public static async Task<Entity> ShowEntityAsync ( this EntityComponent entityComp, int entityID, Type logicType, string assetPath, string entityGroup, int priority, object userData )
        {
#if UNITY_EDITOR
            TipsSubscribeEvent();
#endif
            ...
            entityComp.ShowEntity( entityID, logicType, assetPath, entityGroup, priority, userData );
            //tcs.Task.Start();
