...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestMultiRowTitleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.MultiRowTitle);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X20", _g_get_X20);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeMultiRowTitle", _m_DeserializeMultiRowTitle_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.MultiRowTitle.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.MultiRowTitle(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.MultiRowTitle constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeMultiRowTitle_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.MultiRowTitle.DeserializeMultiRowTitle( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.MultiRowTitle gen_to_be_invoked = (cfg.test.MultiRowTitle)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X20(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.MultiRowTitle gen_to_be_invoked = (cfg.test.MultiRowTitle)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X20);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
