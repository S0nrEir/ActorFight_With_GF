...
namespace XLua.CSObjectWrap
{
    ...
    public class CfgcommonScriptsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cfg.common.Scripts);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeScripts", _m_DeserializeScripts_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", Cfg.common.Scripts.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new Cfg.common.Scripts(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cfg.common.Scripts constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeScripts_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = Cfg.common.Scripts.DeserializeScripts( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                Cfg.common.Scripts gen_to_be_invoked = (Cfg.common.Scripts)translator.FastGetCSObj(L, 1);
