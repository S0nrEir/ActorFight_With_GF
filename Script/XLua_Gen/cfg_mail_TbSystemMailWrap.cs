...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgmailTbSystemMailWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.mail.TbSystemMail);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.mail.TbSystemMail(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.mail.TbSystemMail constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.mail.TbSystemMail>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.mail.TbSystemMail gen_to_be_invoked = (cfg.mail.TbSystemMail)translator.FastGetCSObj(L, 1);
