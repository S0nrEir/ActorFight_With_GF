...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgerrorTbErrorInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.error.TbErrorInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.error.TbErrorInfo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.error.TbErrorInfo constructor!");
        ...
        static int _m_GetOrDefault(RealStatePtr L)
        {
		    try {
                ...
                cfg.error.TbErrorInfo gen_to_be_invoked = (cfg.error.TbErrorInfo)translator.FastGetCSObj(L, 1);
