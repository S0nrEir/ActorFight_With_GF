...
namespace XLua.CSObjectWrap
{
    ...
    public class UGFExtensionsAwaitWebResultWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UGFExtensions.Await.WebResult);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UGFExtensions.Await.WebResult();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UGFExtensions.Await.WebResult constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    bool _isError = LuaAPI.lua_toboolean(L, 2);
                    string _errorMessage = LuaAPI.lua_tostring(L, 3);
                    object _userData = translator.GetObject(L, 4, typeof(object));
                    
                        var gen_ret = UGFExtensions.Await.WebResult.Create( _bytes, _isError, _errorMessage, _userData );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                UGFExtensions.Await.WebResult gen_to_be_invoked = (UGFExtensions.Await.WebResult)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 2);
                    bool _isError = LuaAPI.lua_toboolean(L, 3);
                    string _errorMessage = LuaAPI.lua_tostring(L, 4);
                    object _userData = translator.GetObject(L, 5, typeof(object));
                    
                        var gen_ret = gen_to_be_invoked.Init( _bytes, _isError, _errorMessage, _userData );
                        translator.Push(L, gen_ret);
