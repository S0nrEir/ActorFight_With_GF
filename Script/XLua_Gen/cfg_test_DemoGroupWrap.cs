...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDemoGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DemoGroup);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X2_Ref", _g_get_X2_Ref);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X3", _g_get_X3);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X3_Ref", _g_get_X3_Ref);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDemoGroup", _m_DeserializeDemoGroup_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DemoGroup.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DemoGroup(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DemoGroup constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDemoGroup_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DemoGroup.DeserializeDemoGroup( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoGroup gen_to_be_invoked = (cfg.test.DemoGroup)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X2_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoGroup gen_to_be_invoked = (cfg.test.DemoGroup)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X2_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X3_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoGroup gen_to_be_invoked = (cfg.test.DemoGroup)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X3_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
