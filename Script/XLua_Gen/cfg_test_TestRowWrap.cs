...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestRowWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestRow);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestRow", _m_DeserializeTestRow_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestRow.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestRow(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestRow constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestRow_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestRow.DeserializeTestRow( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestRow gen_to_be_invoked = (cfg.test.TestRow)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Y(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestRow gen_to_be_invoked = (cfg.test.TestRow)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.Y);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_Z(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestRow gen_to_be_invoked = (cfg.test.TestRow)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Z);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
