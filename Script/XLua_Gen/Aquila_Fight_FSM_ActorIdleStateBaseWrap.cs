...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaFightFSMActorIdleStateBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Aquila.Fight.FSM.ActorIdleStateBase);
        ...
        {
            return LuaAPI.luaL_error(L, "Aquila.Fight.FSM.ActorIdleStateBase does not have a constructor!");
        }
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                Aquila.Fight.FSM.ActorIdleStateBase gen_to_be_invoked = (Aquila.Fight.FSM.ActorIdleStateBase)translator.FastGetCSObj(L, 1);
