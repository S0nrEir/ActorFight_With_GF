...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDemoE2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DemoE2);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDemoE2", _m_DeserializeDemoE2_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DemoE2.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DemoE2(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DemoE2 constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDemoE2_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DemoE2.DeserializeDemoE2( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoE2 gen_to_be_invoked = (cfg.test.DemoE2)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Y1(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoE2 gen_to_be_invoked = (cfg.test.DemoE2)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.Y1);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_Y2(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoE2 gen_to_be_invoked = (cfg.test.DemoE2)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.Y2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
