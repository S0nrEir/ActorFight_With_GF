...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestSepWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestSep);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X1_l10n_key", _g_get_X1_l10n_key);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestSep", _m_DeserializeTestSep_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestSep.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestSep(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestSep constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestSep_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestSep.DeserializeTestSep( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_X1(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.X1);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X1_l10n_key(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.X1_l10n_key);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X2(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X3(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X3);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X4(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X4);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X5(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X5);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X6(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestSep gen_to_be_invoked = (cfg.test.TestSep)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X6);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
