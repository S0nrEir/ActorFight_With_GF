...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDemoType2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DemoType2);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X7", _g_get_X7);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X80", _g_get_X80);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X8", _g_get_X8);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "X9", _g_get_X9);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "S1_l10n_key", _g_get_S1_l10n_key);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "K5", _g_get_K5);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "K8", _g_get_K8);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "K8_Ref", _g_get_K8_Ref);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDemoType2", _m_DeserializeDemoType2_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DemoType2.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DemoType2(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DemoType2 constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDemoType2_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DemoType2.DeserializeDemoType2( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X7(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.X7);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X80(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.X80);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_X9(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.X9);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_S1_l10n_key(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.S1_l10n_key);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_K5(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.K5);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_K8_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DemoType2 gen_to_be_invoked = (cfg.test.DemoType2)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.K8_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
