...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaFightAddonProcessorAddonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Aquila.Fight.Addon.ProcessorAddon);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Aquila.Fight.Addon.ProcessorAddon();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Fight.Addon.ProcessorAddon constructor!");
        ...
        static int _m_OnAdd(RealStatePtr L)
        {
		    try {
                ...
                Aquila.Fight.Addon.ProcessorAddon gen_to_be_invoked = (Aquila.Fight.Addon.ProcessorAddon)translator.FastGetCSObj(L, 1);
