...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiBehaviorTreeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.BehaviorTree);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BlackboardId", _g_get_BlackboardId);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BlackboardId_Ref", _g_get_BlackboardId_Ref);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeBehaviorTree", _m_DeserializeBehaviorTree_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.BehaviorTree.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.BehaviorTree(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.BehaviorTree constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeBehaviorTree_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.BehaviorTree.DeserializeBehaviorTree( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.BehaviorTree gen_to_be_invoked = (cfg.ai.BehaviorTree)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BlackboardId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.BehaviorTree gen_to_be_invoked = (cfg.ai.BehaviorTree)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.BlackboardId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BlackboardId_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.BehaviorTree gen_to_be_invoked = (cfg.ai.BehaviorTree)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.BlackboardId_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
