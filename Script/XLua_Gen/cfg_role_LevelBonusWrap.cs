...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgroleLevelBonusWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.role.LevelBonus);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "DistinctBonusInfos", _g_get_DistinctBonusInfos);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeLevelBonus", _m_DeserializeLevelBonus_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.role.LevelBonus.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.role.LevelBonus(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.role.LevelBonus constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeLevelBonus_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.role.LevelBonus.DeserializeLevelBonus( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.role.LevelBonus gen_to_be_invoked = (cfg.role.LevelBonus)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_DistinctBonusInfos(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.role.LevelBonus gen_to_be_invoked = (cfg.role.LevelBonus)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.DistinctBonusInfos);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
