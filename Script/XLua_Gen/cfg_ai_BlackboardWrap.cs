...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiBlackboardWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.Blackboard);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ParentName", _g_get_ParentName);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ParentName_Ref", _g_get_ParentName_Ref);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeBlackboard", _m_DeserializeBlackboard_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.Blackboard.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.Blackboard(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.Blackboard constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeBlackboard_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.Blackboard.DeserializeBlackboard( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.Blackboard gen_to_be_invoked = (cfg.ai.Blackboard)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ParentName(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.Blackboard gen_to_be_invoked = (cfg.ai.Blackboard)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.ParentName);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ParentName_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.Blackboard gen_to_be_invoked = (cfg.ai.Blackboard)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.ParentName_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
