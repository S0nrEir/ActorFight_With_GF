...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiMoveToRandomLocationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.MoveToRandomLocation);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "OriginPositionKey", _g_get_OriginPositionKey);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeMoveToRandomLocation", _m_DeserializeMoveToRandomLocation_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.MoveToRandomLocation.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.MoveToRandomLocation(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.MoveToRandomLocation constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeMoveToRandomLocation_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.MoveToRandomLocation.DeserializeMoveToRandomLocation( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.MoveToRandomLocation gen_to_be_invoked = (cfg.ai.MoveToRandomLocation)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_OriginPositionKey(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.MoveToRandomLocation gen_to_be_invoked = (cfg.ai.MoveToRandomLocation)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.OriginPositionKey);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
