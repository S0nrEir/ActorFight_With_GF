...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusBonusWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.Bonus);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeBonus", _m_DeserializeBonus_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.bonus.Bonus does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeBonus_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.Bonus.DeserializeBonus( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.Bonus gen_to_be_invoked = (cfg.bonus.Bonus)translator.FastGetCSObj(L, 1);
