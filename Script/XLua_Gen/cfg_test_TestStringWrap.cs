...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestStringWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestString);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Cs1", _g_get_Cs1);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Cs2", _g_get_Cs2);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestString", _m_DeserializeTestString_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestString.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestString(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestString constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestString_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestString.DeserializeTestString( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestString gen_to_be_invoked = (cfg.test.TestString)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Cs1(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.TestString gen_to_be_invoked = (cfg.test.TestString)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Cs1);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Cs2(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.TestString gen_to_be_invoked = (cfg.test.TestString)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Cs2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
