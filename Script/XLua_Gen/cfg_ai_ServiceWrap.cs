...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiServiceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.Service);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeService", _m_DeserializeService_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.Service does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeService_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.Service.DeserializeService( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.Service gen_to_be_invoked = (cfg.ai.Service)translator.FastGetCSObj(L, 1);
