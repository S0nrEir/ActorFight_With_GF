...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusShowItemInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.ShowItemInfo);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ItemId_Ref", _g_get_ItemId_Ref);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ItemNum", _g_get_ItemNum);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeShowItemInfo", _m_DeserializeShowItemInfo_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.ShowItemInfo.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.ShowItemInfo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.ShowItemInfo constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeShowItemInfo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.ShowItemInfo.DeserializeShowItemInfo( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.ShowItemInfo gen_to_be_invoked = (cfg.bonus.ShowItemInfo)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ItemId_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.ShowItemInfo gen_to_be_invoked = (cfg.bonus.ShowItemInfo)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.ItemId_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ItemNum(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.ShowItemInfo gen_to_be_invoked = (cfg.bonus.ShowItemInfo)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.ItemNum);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
