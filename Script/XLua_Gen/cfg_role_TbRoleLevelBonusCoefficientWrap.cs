...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgroleTbRoleLevelBonusCoefficientWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.role.TbRoleLevelBonusCoefficient);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.role.TbRoleLevelBonusCoefficient(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.role.TbRoleLevelBonusCoefficient constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.role.TbRoleLevelBonusCoefficient>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.role.TbRoleLevelBonusCoefficient gen_to_be_invoked = (cfg.role.TbRoleLevelBonusCoefficient)translator.FastGetCSObj(L, 1);
