...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgconditionClothesPropertyScoreGreaterThanWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.condition.ClothesPropertyScoreGreaterThan);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Prop", _g_get_Prop);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeClothesPropertyScoreGreaterThan", _m_DeserializeClothesPropertyScoreGreaterThan_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.condition.ClothesPropertyScoreGreaterThan.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.condition.ClothesPropertyScoreGreaterThan(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.condition.ClothesPropertyScoreGreaterThan constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeClothesPropertyScoreGreaterThan_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.condition.ClothesPropertyScoreGreaterThan.DeserializeClothesPropertyScoreGreaterThan( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.condition.ClothesPropertyScoreGreaterThan gen_to_be_invoked = (cfg.condition.ClothesPropertyScoreGreaterThan)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Prop(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.condition.ClothesPropertyScoreGreaterThan gen_to_be_invoked = (cfg.condition.ClothesPropertyScoreGreaterThan)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Prop);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
