...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestNullWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestNull);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestNull", _m_DeserializeTestNull_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestNull.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestNull(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestNull constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestNull_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestNull.DeserializeTestNull( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestNull gen_to_be_invoked = (cfg.test.TestNull)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_X1(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestNull gen_to_be_invoked = (cfg.test.TestNull)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.X1);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X2(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestNull gen_to_be_invoked = (cfg.test.TestNull)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.X2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
