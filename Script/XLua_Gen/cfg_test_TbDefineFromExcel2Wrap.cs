...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTbDefineFromExcel2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TbDefineFromExcel2);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TbDefineFromExcel2(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TbDefineFromExcel2 constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.test.TbDefineFromExcel2>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.test.TbDefineFromExcel2 gen_to_be_invoked = (cfg.test.TbDefineFromExcel2)translator.FastGetCSObj(L, 1);
