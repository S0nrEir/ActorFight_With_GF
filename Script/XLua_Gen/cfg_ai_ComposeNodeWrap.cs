...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiComposeNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.ComposeNode);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeComposeNode", _m_DeserializeComposeNode_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.ComposeNode does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeComposeNode_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.ComposeNode.DeserializeComposeNode( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.ComposeNode gen_to_be_invoked = (cfg.ai.ComposeNode)translator.FastGetCSObj(L, 1);
