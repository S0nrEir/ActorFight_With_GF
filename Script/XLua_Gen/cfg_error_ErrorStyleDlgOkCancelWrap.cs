...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgerrorErrorStyleDlgOkCancelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.error.ErrorStyleDlgOkCancel);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Btn1Name", _g_get_Btn1Name);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Btn2Name", _g_get_Btn2Name);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeErrorStyleDlgOkCancel", _m_DeserializeErrorStyleDlgOkCancel_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.error.ErrorStyleDlgOkCancel.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.error.ErrorStyleDlgOkCancel(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.error.ErrorStyleDlgOkCancel constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeErrorStyleDlgOkCancel_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.error.ErrorStyleDlgOkCancel.DeserializeErrorStyleDlgOkCancel( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.error.ErrorStyleDlgOkCancel gen_to_be_invoked = (cfg.error.ErrorStyleDlgOkCancel)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Btn1Name(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.error.ErrorStyleDlgOkCancel gen_to_be_invoked = (cfg.error.ErrorStyleDlgOkCancel)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Btn1Name);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Btn2Name(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.error.ErrorStyleDlgOkCancel gen_to_be_invoked = (cfg.error.ErrorStyleDlgOkCancel)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Btn2Name);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
