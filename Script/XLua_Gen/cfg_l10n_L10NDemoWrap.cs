...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgl10nL10NDemoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.l10n.L10NDemo);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Text_l10n_key", _g_get_Text_l10n_key);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeL10NDemo", _m_DeserializeL10NDemo_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.l10n.L10NDemo.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.l10n.L10NDemo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.l10n.L10NDemo constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeL10NDemo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.l10n.L10NDemo.DeserializeL10NDemo( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.l10n.L10NDemo gen_to_be_invoked = (cfg.l10n.L10NDemo)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Text_l10n_key(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.l10n.L10NDemo gen_to_be_invoked = (cfg.l10n.L10NDemo)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Text_l10n_key);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
