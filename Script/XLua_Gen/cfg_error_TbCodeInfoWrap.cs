...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgerrorTbCodeInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.error.TbCodeInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.error.TbCodeInfo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.error.TbCodeInfo constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.error.TbCodeInfo>(L, 1) && translator.Assignable<cfg.error.EErrorCode>(L, 2))
				{
					
					cfg.error.TbCodeInfo gen_to_be_invoked = (cfg.error.TbCodeInfo)translator.FastGetCSObj(L, 1);
					cfg.error.EErrorCode index;translator.Get(L, 2, out index);
        ...
        static int _m_GetOrDefault(RealStatePtr L)
        {
		    try {
                ...
                {
                    cfg.error.EErrorCode _key;translator.Get(L, 2, out _key);
