...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTbTestDescWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TbTestDesc);
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 1, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetById", _m_GetById);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetByName", _m_GetByName);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TbTestDesc(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TbTestDesc constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetById(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TbTestDesc gen_to_be_invoked = (cfg.test.TbTestDesc)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    int _key = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetById( _key );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetByName(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _key = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetByName( _key );
                        translator.Push(L, gen_ret);
