...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDetectEncodingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DetectEncoding);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDetectEncoding", _m_DeserializeDetectEncoding_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DetectEncoding.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DetectEncoding(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DetectEncoding constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDetectEncoding_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DetectEncoding.DeserializeDetectEncoding( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DetectEncoding gen_to_be_invoked = (cfg.test.DetectEncoding)translator.FastGetCSObj(L, 1);
