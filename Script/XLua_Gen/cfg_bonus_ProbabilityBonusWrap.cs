...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusProbabilityBonusWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.ProbabilityBonus);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Bonuses", _g_get_Bonuses);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeProbabilityBonus", _m_DeserializeProbabilityBonus_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.ProbabilityBonus.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.ProbabilityBonus(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.ProbabilityBonus constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeProbabilityBonus_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.ProbabilityBonus.DeserializeProbabilityBonus( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.ProbabilityBonus gen_to_be_invoked = (cfg.bonus.ProbabilityBonus)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Bonuses(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.ProbabilityBonus gen_to_be_invoked = (cfg.bonus.ProbabilityBonus)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Bonuses);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
