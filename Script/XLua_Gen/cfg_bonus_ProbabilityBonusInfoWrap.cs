...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusProbabilityBonusInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.ProbabilityBonusInfo);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeProbabilityBonusInfo", _m_DeserializeProbabilityBonusInfo_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.ProbabilityBonusInfo.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.ProbabilityBonusInfo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.ProbabilityBonusInfo constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeProbabilityBonusInfo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.ProbabilityBonusInfo.DeserializeProbabilityBonusInfo( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.ProbabilityBonusInfo gen_to_be_invoked = (cfg.bonus.ProbabilityBonusInfo)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Bonus(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.ProbabilityBonusInfo gen_to_be_invoked = (cfg.bonus.ProbabilityBonusInfo)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Bonus);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
