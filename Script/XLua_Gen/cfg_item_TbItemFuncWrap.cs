...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgitemTbItemFuncWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.item.TbItemFunc);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.item.TbItemFunc(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.item.TbItemFunc constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.item.TbItemFunc>(L, 1) && translator.Assignable<cfg.item.EMinorType>(L, 2))
				{
					
					cfg.item.TbItemFunc gen_to_be_invoked = (cfg.item.TbItemFunc)translator.FastGetCSObj(L, 1);
					cfg.item.EMinorType index;translator.Get(L, 2, out index);
        ...
        static int _m_GetOrDefault(RealStatePtr L)
        {
		    try {
                ...
                {
                    cfg.item.EMinorType _key;translator.Get(L, 2, out _key);
