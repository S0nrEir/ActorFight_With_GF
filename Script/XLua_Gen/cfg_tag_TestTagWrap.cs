...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtagTestTagWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.tag.TestTag);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestTag", _m_DeserializeTestTag_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.tag.TestTag.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.tag.TestTag(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.tag.TestTag constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestTag_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.tag.TestTag.DeserializeTestTag( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.tag.TestTag gen_to_be_invoked = (cfg.tag.TestTag)translator.FastGetCSObj(L, 1);
