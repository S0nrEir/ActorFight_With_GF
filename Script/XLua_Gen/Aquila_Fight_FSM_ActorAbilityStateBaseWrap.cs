...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaFightFSMActorAbilityStateBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Aquila.Fight.FSM.ActorAbilityStateBase);
        ...
        {
            return LuaAPI.luaL_error(L, "Aquila.Fight.FSM.ActorAbilityStateBase does not have a constructor!");
        }
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                Aquila.Fight.FSM.ActorAbilityStateBase gen_to_be_invoked = (Aquila.Fight.FSM.ActorAbilityStateBase)translator.FastGetCSObj(L, 1);
