...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiGetOwnerPlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.GetOwnerPlayer);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "PlayerActorKey", _g_get_PlayerActorKey);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeGetOwnerPlayer", _m_DeserializeGetOwnerPlayer_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.GetOwnerPlayer.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.GetOwnerPlayer(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.GetOwnerPlayer constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeGetOwnerPlayer_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.GetOwnerPlayer.DeserializeGetOwnerPlayer( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.GetOwnerPlayer gen_to_be_invoked = (cfg.ai.GetOwnerPlayer)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_PlayerActorKey(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.GetOwnerPlayer gen_to_be_invoked = (cfg.ai.GetOwnerPlayer)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.PlayerActorKey);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
