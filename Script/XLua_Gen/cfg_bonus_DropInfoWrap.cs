...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusDropInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.DropInfo);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ClientShowItems", _g_get_ClientShowItems);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDropInfo", _m_DeserializeDropInfo_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.DropInfo.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.DropInfo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.DropInfo constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDropInfo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.DropInfo.DeserializeDropInfo( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.DropInfo gen_to_be_invoked = (cfg.bonus.DropInfo)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ClientShowItems(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.DropInfo gen_to_be_invoked = (cfg.bonus.DropInfo)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.ClientShowItems);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
