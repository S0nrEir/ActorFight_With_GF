...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgcommonDateTimeRangeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.common.DateTimeRange);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.common.DateTimeRange.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.common.DateTimeRange(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.common.DateTimeRange constructor!");
		    ...
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.common.DateTimeRange.DeserializeDateTimeRange( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.common.DateTimeRange gen_to_be_invoked = (cfg.common.DateTimeRange)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_StartTime(RealStatePtr L)
        {
		    try {
                ...
                cfg.common.DateTimeRange gen_to_be_invoked = (cfg.common.DateTimeRange)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.StartTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_EndTime(RealStatePtr L)
        {
		    try {
                ...
                cfg.common.DateTimeRange gen_to_be_invoked = (cfg.common.DateTimeRange)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.EndTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
