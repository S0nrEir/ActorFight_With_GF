...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtagTbTestTagWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.tag.TbTestTag);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.tag.TbTestTag(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.tag.TbTestTag constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.tag.TbTestTag>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.tag.TbTestTag gen_to_be_invoked = (cfg.tag.TbTestTag)translator.FastGetCSObj(L, 1);
