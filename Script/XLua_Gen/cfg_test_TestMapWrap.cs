...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestMapWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestMap);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Id_Ref", _g_get_Id_Ref);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestMap", _m_DeserializeTestMap_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestMap.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestMap(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestMap constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestMap_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestMap.DeserializeTestMap( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestMap gen_to_be_invoked = (cfg.test.TestMap)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Id_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.TestMap gen_to_be_invoked = (cfg.test.TestMap)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Id_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_X1(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestMap gen_to_be_invoked = (cfg.test.TestMap)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.X1);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
