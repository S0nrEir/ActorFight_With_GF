...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaModuleModule_SceneModule_Fighting_TerrainWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Aquila.Module.Module_Scene.Module_Fighting_Terrain);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Aquila.Module.Module_Scene.Module_Fighting_Terrain();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Module.Module_Scene.Module_Fighting_Terrain constructor!");
        ...
        static int _m_Start(RealStatePtr L)
        {
		    try {
                ...
                Aquila.Module.Module_Scene.Module_Fighting_Terrain gen_to_be_invoked = (Aquila.Module.Module_Scene.Module_Fighting_Terrain)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Get(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Module.Module_Scene.Module_Fighting_Terrain.Get!");
