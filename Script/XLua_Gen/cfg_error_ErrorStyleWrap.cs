...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgerrorErrorStyleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.error.ErrorStyle);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeErrorStyle", _m_DeserializeErrorStyle_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.error.ErrorStyle does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeErrorStyle_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.error.ErrorStyle.DeserializeErrorStyle( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.error.ErrorStyle gen_to_be_invoked = (cfg.error.ErrorStyle)translator.FastGetCSObj(L, 1);
