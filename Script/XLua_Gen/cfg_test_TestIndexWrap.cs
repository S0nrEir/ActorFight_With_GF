...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestIndexWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestIndex);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Eles", _g_get_Eles);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestIndex", _m_DeserializeTestIndex_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestIndex.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestIndex(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestIndex constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestIndex_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestIndex.DeserializeTestIndex( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestIndex gen_to_be_invoked = (cfg.test.TestIndex)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Eles(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.TestIndex gen_to_be_invoked = (cfg.test.TestIndex)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Eles);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
