...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaFightAddonEventAddonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Aquila.Fight.Addon.EventAddon);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Aquila.Fight.Addon.EventAddon();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Fight.Addon.EventAddon constructor!");
        ...
        static int _m_Trigger(RealStatePtr L)
        {
		    try {
                ...
                Aquila.Fight.Addon.EventAddon gen_to_be_invoked = (Aquila.Fight.Addon.EventAddon)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Register(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Action<int, object[]>>(L, 3)) 
                {
                    int _intType = LuaAPI.xlua_tointeger(L, 2);
                    System.Action<int, object[]> _action = translator.GetDelegate<System.Action<int, object[]>>(L, 3);
                    
                        var gen_ret = gen_to_be_invoked.Register( _intType, _action );
                ...
                if(gen_param_count == 3&& translator.Assignable<Aquila.Fight.Addon.ActorEventEnum>(L, 2)&& translator.Assignable<System.Action<int, object[]>>(L, 3)) 
                {
                    Aquila.Fight.Addon.ActorEventEnum _eventType;translator.Get(L, 2, out _eventType);
                    System.Action<int, object[]> _action = translator.GetDelegate<System.Action<int, object[]>>(L, 3);
                    
                        var gen_ret = gen_to_be_invoked.Register( _eventType, _action );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Fight.Addon.EventAddon.Register!");
        ...
        static int _m_UnRegister(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int _intType = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.UnRegister( _intType );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<Aquila.Fight.Addon.ActorEventEnum>(L, 2)) 
                {
                    Aquila.Fight.Addon.ActorEventEnum _eventType;translator.Get(L, 2, out _eventType);
                    
                        var gen_ret = gen_to_be_invoked.UnRegister( _eventType );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Fight.Addon.EventAddon.UnRegister!");
