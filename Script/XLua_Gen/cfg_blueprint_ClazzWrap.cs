...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgblueprintClazzWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.blueprint.Clazz);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Parents", _g_get_Parents);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Methods", _g_get_Methods);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeClazz", _m_DeserializeClazz_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.blueprint.Clazz does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeClazz_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.blueprint.Clazz.DeserializeClazz( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.blueprint.Clazz gen_to_be_invoked = (cfg.blueprint.Clazz)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Parents(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.blueprint.Clazz gen_to_be_invoked = (cfg.blueprint.Clazz)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Parents);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Methods(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.blueprint.Clazz gen_to_be_invoked = (cfg.blueprint.Clazz)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Methods);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
