...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgroleDistinctBonusInfosWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.role.DistinctBonusInfos);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "EffectiveLevel", _g_get_EffectiveLevel);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BonusInfo", _g_get_BonusInfo);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDistinctBonusInfos", _m_DeserializeDistinctBonusInfos_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.role.DistinctBonusInfos.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.role.DistinctBonusInfos(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.role.DistinctBonusInfos constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDistinctBonusInfos_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.role.DistinctBonusInfos.DeserializeDistinctBonusInfos( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.role.DistinctBonusInfos gen_to_be_invoked = (cfg.role.DistinctBonusInfos)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_EffectiveLevel(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.role.DistinctBonusInfos gen_to_be_invoked = (cfg.role.DistinctBonusInfos)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.EffectiveLevel);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BonusInfo(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.role.DistinctBonusInfos gen_to_be_invoked = (cfg.role.DistinctBonusInfos)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.BonusInfo);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
