...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiUeCooldownWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.UeCooldown);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "CooldownTime", _g_get_CooldownTime);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeUeCooldown", _m_DeserializeUeCooldown_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.UeCooldown.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.UeCooldown(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.UeCooldown constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeUeCooldown_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.UeCooldown.DeserializeUeCooldown( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.UeCooldown gen_to_be_invoked = (cfg.ai.UeCooldown)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_CooldownTime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.UeCooldown gen_to_be_invoked = (cfg.ai.UeCooldown)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.CooldownTime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
