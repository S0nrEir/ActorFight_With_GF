...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgitemItemExtraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.item.ItemExtra);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeItemExtra", _m_DeserializeItemExtra_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.item.ItemExtra does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeItemExtra_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.item.ItemExtra.DeserializeItemExtra( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.item.ItemExtra gen_to_be_invoked = (cfg.item.ItemExtra)translator.FastGetCSObj(L, 1);
