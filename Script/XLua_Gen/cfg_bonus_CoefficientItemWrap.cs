...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusCoefficientItemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.CoefficientItem);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "BonusId", _g_get_BonusId);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BonusList", _g_get_BonusList);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeCoefficientItem", _m_DeserializeCoefficientItem_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.CoefficientItem.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.CoefficientItem(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.CoefficientItem constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeCoefficientItem_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.CoefficientItem.DeserializeCoefficientItem( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.CoefficientItem gen_to_be_invoked = (cfg.bonus.CoefficientItem)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BonusId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.CoefficientItem gen_to_be_invoked = (cfg.bonus.CoefficientItem)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.BonusId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BonusList(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.CoefficientItem gen_to_be_invoked = (cfg.bonus.CoefficientItem)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.BonusList);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
