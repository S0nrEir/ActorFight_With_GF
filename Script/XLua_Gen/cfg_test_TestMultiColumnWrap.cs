...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestMultiColumnWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestMultiColumn);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestMultiColumn", _m_DeserializeTestMultiColumn_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestMultiColumn.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestMultiColumn(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestMultiColumn constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestMultiColumn_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestMultiColumn.DeserializeTestMultiColumn( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestMultiColumn gen_to_be_invoked = (cfg.test.TestMultiColumn)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_B(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestMultiColumn gen_to_be_invoked = (cfg.test.TestMultiColumn)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.B);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_C(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestMultiColumn gen_to_be_invoked = (cfg.test.TestMultiColumn)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.C);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
