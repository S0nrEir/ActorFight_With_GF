...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestShapeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.Shape);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeShape", _m_DeserializeShape_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.test.Shape does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeShape_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.Shape.DeserializeShape( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.Shape gen_to_be_invoked = (cfg.test.Shape)translator.FastGetCSObj(L, 1);
