...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgitemItemFunctionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.item.ItemFunction);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "CloseBagUi", _g_get_CloseBagUi);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeItemFunction", _m_DeserializeItemFunction_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.item.ItemFunction.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.item.ItemFunction(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.item.ItemFunction constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeItemFunction_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.item.ItemFunction.DeserializeItemFunction( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.item.ItemFunction gen_to_be_invoked = (cfg.item.ItemFunction)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_FuncType(RealStatePtr L)
        {
		    try {
                ...
                cfg.item.ItemFunction gen_to_be_invoked = (cfg.item.ItemFunction)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.FuncType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_CloseBagUi(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.item.ItemFunction gen_to_be_invoked = (cfg.item.ItemFunction)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.CloseBagUi);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
