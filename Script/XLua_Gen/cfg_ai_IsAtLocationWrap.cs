...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiIsAtLocationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.IsAtLocation);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "AcceptableRadius", _g_get_AcceptableRadius);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "KeyboardKey", _g_get_KeyboardKey);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "InverseCondition", _g_get_InverseCondition);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeIsAtLocation", _m_DeserializeIsAtLocation_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.IsAtLocation.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.IsAtLocation(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.IsAtLocation constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeIsAtLocation_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.IsAtLocation.DeserializeIsAtLocation( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.IsAtLocation gen_to_be_invoked = (cfg.ai.IsAtLocation)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_AcceptableRadius(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.IsAtLocation gen_to_be_invoked = (cfg.ai.IsAtLocation)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.AcceptableRadius);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_InverseCondition(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.IsAtLocation gen_to_be_invoked = (cfg.ai.IsAtLocation)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.InverseCondition);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
