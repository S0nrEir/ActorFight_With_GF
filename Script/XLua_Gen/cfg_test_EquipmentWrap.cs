...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestEquipmentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.Equipment);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Attr", _g_get_Attr);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeEquipment", _m_DeserializeEquipment_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.Equipment.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.Equipment(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.Equipment constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeEquipment_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.Equipment.DeserializeEquipment( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.Equipment gen_to_be_invoked = (cfg.test.Equipment)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Attr(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.Equipment gen_to_be_invoked = (cfg.test.Equipment)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Attr);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
