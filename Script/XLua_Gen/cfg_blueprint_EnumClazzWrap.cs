...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgblueprintEnumClazzWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.blueprint.EnumClazz);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Enums", _g_get_Enums);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeEnumClazz", _m_DeserializeEnumClazz_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.blueprint.EnumClazz.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.blueprint.EnumClazz(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.blueprint.EnumClazz constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeEnumClazz_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.blueprint.EnumClazz.DeserializeEnumClazz( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.blueprint.EnumClazz gen_to_be_invoked = (cfg.blueprint.EnumClazz)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Enums(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.blueprint.EnumClazz gen_to_be_invoked = (cfg.blueprint.EnumClazz)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Enums);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
