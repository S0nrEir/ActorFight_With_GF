...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusOneItemsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.OneItems);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Items_Ref", _g_get_Items_Ref);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeOneItems", _m_DeserializeOneItems_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.OneItems.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.OneItems(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.OneItems constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeOneItems_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.OneItems.DeserializeOneItems( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.OneItems gen_to_be_invoked = (cfg.bonus.OneItems)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Items_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.bonus.OneItems gen_to_be_invoked = (cfg.bonus.OneItems)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Items_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
