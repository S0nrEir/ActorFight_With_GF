...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgitemDesignDrawingWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.item.DesignDrawing);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "LearnComponentId", _g_get_LearnComponentId);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDesignDrawing", _m_DeserializeDesignDrawing_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.item.DesignDrawing.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.item.DesignDrawing(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.item.DesignDrawing constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDesignDrawing_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.item.DesignDrawing.DeserializeDesignDrawing( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.item.DesignDrawing gen_to_be_invoked = (cfg.item.DesignDrawing)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_LearnComponentId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.item.DesignDrawing gen_to_be_invoked = (cfg.item.DesignDrawing)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.LearnComponentId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
