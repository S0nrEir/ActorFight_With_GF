...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDefineFromExcel2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DefineFromExcel2);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDefineFromExcel2", _m_DeserializeDefineFromExcel2_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DefineFromExcel2.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DefineFromExcel2(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DefineFromExcel2 constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDefineFromExcel2_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DefineFromExcel2.DeserializeDefineFromExcel2( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DefineFromExcel2 gen_to_be_invoked = (cfg.test.DefineFromExcel2)translator.FastGetCSObj(L, 1);
