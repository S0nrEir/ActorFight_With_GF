...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiDistanceLessThanWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.DistanceLessThan);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Actor1Key", _g_get_Actor1Key);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Actor2Key", _g_get_Actor2Key);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Distance", _g_get_Distance);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ReverseResult", _g_get_ReverseResult);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDistanceLessThan", _m_DeserializeDistanceLessThan_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.DistanceLessThan.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.DistanceLessThan(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.DistanceLessThan constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDistanceLessThan_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.DistanceLessThan.DeserializeDistanceLessThan( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.DistanceLessThan gen_to_be_invoked = (cfg.ai.DistanceLessThan)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Actor1Key(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.DistanceLessThan gen_to_be_invoked = (cfg.ai.DistanceLessThan)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Actor1Key);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Actor2Key(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.DistanceLessThan gen_to_be_invoked = (cfg.ai.DistanceLessThan)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Actor2Key);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ReverseResult(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.DistanceLessThan gen_to_be_invoked = (cfg.ai.DistanceLessThan)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.ReverseResult);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
