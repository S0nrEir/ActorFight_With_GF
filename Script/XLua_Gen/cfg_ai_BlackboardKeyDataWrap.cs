...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiBlackboardKeyDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.BlackboardKeyData);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeBlackboardKeyData", _m_DeserializeBlackboardKeyData_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.BlackboardKeyData.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.BlackboardKeyData(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.BlackboardKeyData constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeBlackboardKeyData_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.BlackboardKeyData.DeserializeBlackboardKeyData( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.BlackboardKeyData gen_to_be_invoked = (cfg.ai.BlackboardKeyData)translator.FastGetCSObj(L, 1);
