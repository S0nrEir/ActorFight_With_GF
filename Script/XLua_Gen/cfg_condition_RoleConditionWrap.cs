...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgconditionRoleConditionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.condition.RoleCondition);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeRoleCondition", _m_DeserializeRoleCondition_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.condition.RoleCondition does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeRoleCondition_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.condition.RoleCondition.DeserializeRoleCondition( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.condition.RoleCondition gen_to_be_invoked = (cfg.condition.RoleCondition)translator.FastGetCSObj(L, 1);
