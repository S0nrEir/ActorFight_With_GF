...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiKeyDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.KeyData);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeKeyData", _m_DeserializeKeyData_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.KeyData does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeKeyData_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.KeyData.DeserializeKeyData( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.KeyData gen_to_be_invoked = (cfg.ai.KeyData)translator.FastGetCSObj(L, 1);
