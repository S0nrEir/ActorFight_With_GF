...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaFightFSMActorDieStateBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Aquila.Fight.FSM.ActorDieStateBase);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new Aquila.Fight.FSM.ActorDieStateBase(_stateID);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Aquila.Fight.FSM.ActorDieStateBase constructor!");
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                Aquila.Fight.FSM.ActorDieStateBase gen_to_be_invoked = (Aquila.Fight.FSM.ActorDieStateBase)translator.FastGetCSObj(L, 1);
