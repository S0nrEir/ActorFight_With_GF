...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusWeightItemInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.WeightItemInfo);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeWeightItemInfo", _m_DeserializeWeightItemInfo_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.bonus.WeightItemInfo.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.WeightItemInfo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.WeightItemInfo constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeWeightItemInfo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.bonus.WeightItemInfo.DeserializeWeightItemInfo( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.WeightItemInfo gen_to_be_invoked = (cfg.bonus.WeightItemInfo)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Weight(RealStatePtr L)
        {
		    try {
                ...
                cfg.bonus.WeightItemInfo gen_to_be_invoked = (cfg.bonus.WeightItemInfo)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.Weight);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
