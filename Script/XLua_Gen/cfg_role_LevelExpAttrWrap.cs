...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgroleLevelExpAttrWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.role.LevelExpAttr);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "ClothesAttrs", _g_get_ClothesAttrs);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeLevelExpAttr", _m_DeserializeLevelExpAttr_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.role.LevelExpAttr.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.role.LevelExpAttr(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.role.LevelExpAttr constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeLevelExpAttr_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.role.LevelExpAttr.DeserializeLevelExpAttr( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.role.LevelExpAttr gen_to_be_invoked = (cfg.role.LevelExpAttr)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_NeedExp(RealStatePtr L)
        {
		    try {
                ...
                cfg.role.LevelExpAttr gen_to_be_invoked = (cfg.role.LevelExpAttr)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.NeedExp);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ClothesAttrs(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.role.LevelExpAttr gen_to_be_invoked = (cfg.role.LevelExpAttr)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.ClothesAttrs);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
