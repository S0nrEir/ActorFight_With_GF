...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgerrorErrorStyleMsgboxWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.error.ErrorStyleMsgbox);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "BtnName", _g_get_BtnName);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeErrorStyleMsgbox", _m_DeserializeErrorStyleMsgbox_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.error.ErrorStyleMsgbox.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.error.ErrorStyleMsgbox(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.error.ErrorStyleMsgbox constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeErrorStyleMsgbox_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.error.ErrorStyleMsgbox.DeserializeErrorStyleMsgbox( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.error.ErrorStyleMsgbox gen_to_be_invoked = (cfg.error.ErrorStyleMsgbox)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BtnName(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.error.ErrorStyleMsgbox gen_to_be_invoked = (cfg.error.ErrorStyleMsgbox)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.BtnName);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
