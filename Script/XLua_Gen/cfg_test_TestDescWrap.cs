...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTestDescWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TestDesc);
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 7, 0);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTestDesc", _m_DeserializeTestDesc_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.TestDesc.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TestDesc(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TestDesc constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTestDesc_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.TestDesc.DeserializeTestDesc( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestDesc gen_to_be_invoked = (cfg.test.TestDesc)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_A2(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TestDesc gen_to_be_invoked = (cfg.test.TestDesc)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.A2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
