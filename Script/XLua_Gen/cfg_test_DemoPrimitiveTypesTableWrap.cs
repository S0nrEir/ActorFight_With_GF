...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDemoPrimitiveTypesTableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DemoPrimitiveTypesTable);
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 15, 0);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDemoPrimitiveTypesTable", _m_DeserializeDemoPrimitiveTypesTable_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DemoPrimitiveTypesTable.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DemoPrimitiveTypesTable(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DemoPrimitiveTypesTable constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDemoPrimitiveTypesTable_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DemoPrimitiveTypesTable.DeserializeDemoPrimitiveTypesTable( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoPrimitiveTypesTable gen_to_be_invoked = (cfg.test.DemoPrimitiveTypesTable)translator.FastGetCSObj(L, 1);
