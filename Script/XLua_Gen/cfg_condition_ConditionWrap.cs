...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgconditionConditionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.condition.Condition);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeCondition", _m_DeserializeCondition_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.condition.Condition does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeCondition_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.condition.Condition.DeserializeCondition( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.condition.Condition gen_to_be_invoked = (cfg.condition.Condition)translator.FastGetCSObj(L, 1);
