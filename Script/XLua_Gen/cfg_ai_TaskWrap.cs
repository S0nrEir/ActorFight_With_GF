...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiTaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.Task);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "IgnoreRestartSelf", _g_get_IgnoreRestartSelf);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTask", _m_DeserializeTask_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.Task does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTask_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.Task.DeserializeTask( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.Task gen_to_be_invoked = (cfg.ai.Task)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_IgnoreRestartSelf(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.Task gen_to_be_invoked = (cfg.ai.Task)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.IgnoreRestartSelf);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
