...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestCompositeJsonTable2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.CompositeJsonTable2);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeCompositeJsonTable2", _m_DeserializeCompositeJsonTable2_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.CompositeJsonTable2.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.CompositeJsonTable2(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.CompositeJsonTable2 constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeCompositeJsonTable2_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.CompositeJsonTable2.DeserializeCompositeJsonTable2( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.CompositeJsonTable2 gen_to_be_invoked = (cfg.test.CompositeJsonTable2)translator.FastGetCSObj(L, 1);
