...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaToolsLuaWrap 
    {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetScriptName_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetChunkName_xlua_st_(RealStatePtr L)
        {
		    try {
		    ...
		    try {
                ...
                
                {
                    string _meta_asset_path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = Aquila.Tools.Lua.GetScriptAssetPath( _meta_asset_path );
                        LuaAPI.lua_pushstring(L, gen_ret);
