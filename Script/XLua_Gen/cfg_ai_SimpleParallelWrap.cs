...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiSimpleParallelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.SimpleParallel);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "FinishMode", _g_get_FinishMode);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "MainTask", _g_get_MainTask);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BackgroundNode", _g_get_BackgroundNode);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeSimpleParallel", _m_DeserializeSimpleParallel_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.SimpleParallel.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.SimpleParallel(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.SimpleParallel constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeSimpleParallel_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.SimpleParallel.DeserializeSimpleParallel( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.SimpleParallel gen_to_be_invoked = (cfg.ai.SimpleParallel)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_FinishMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.SimpleParallel gen_to_be_invoked = (cfg.ai.SimpleParallel)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.FinishMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_MainTask(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.SimpleParallel gen_to_be_invoked = (cfg.ai.SimpleParallel)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.MainTask);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BackgroundNode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.SimpleParallel gen_to_be_invoked = (cfg.ai.SimpleParallel)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.BackgroundNode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
