...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgerrorErrorStyleTipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.error.ErrorStyleTip);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeErrorStyleTip", _m_DeserializeErrorStyleTip_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.error.ErrorStyleTip.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.error.ErrorStyleTip(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.error.ErrorStyleTip constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeErrorStyleTip_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.error.ErrorStyleTip.DeserializeErrorStyleTip( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.error.ErrorStyleTip gen_to_be_invoked = (cfg.error.ErrorStyleTip)translator.FastGetCSObj(L, 1);
