...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiTbBlackboardWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.TbBlackboard);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.TbBlackboard(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.TbBlackboard constructor!");
        ...
        static int _m_GetOrDefault(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.TbBlackboard gen_to_be_invoked = (cfg.ai.TbBlackboard)translator.FastGetCSObj(L, 1);
