...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgcostCostCurrenciesWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.cost.CostCurrencies);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Currencies", _g_get_Currencies);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeCostCurrencies", _m_DeserializeCostCurrencies_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.cost.CostCurrencies.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.cost.CostCurrencies(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.cost.CostCurrencies constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeCostCurrencies_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.cost.CostCurrencies.DeserializeCostCurrencies( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.cost.CostCurrencies gen_to_be_invoked = (cfg.cost.CostCurrencies)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Currencies(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.cost.CostCurrencies gen_to_be_invoked = (cfg.cost.CostCurrencies)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Currencies);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
