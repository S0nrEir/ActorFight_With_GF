...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgmailSystemMailWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.mail.SystemMail);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeSystemMail", _m_DeserializeSystemMail_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.mail.SystemMail.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.mail.SystemMail(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.mail.SystemMail constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeSystemMail_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.mail.SystemMail.DeserializeSystemMail( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.mail.SystemMail gen_to_be_invoked = (cfg.mail.SystemMail)translator.FastGetCSObj(L, 1);
