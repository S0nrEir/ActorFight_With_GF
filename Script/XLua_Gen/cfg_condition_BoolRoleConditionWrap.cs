...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgconditionBoolRoleConditionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.condition.BoolRoleCondition);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeBoolRoleCondition", _m_DeserializeBoolRoleCondition_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.condition.BoolRoleCondition does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeBoolRoleCondition_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.condition.BoolRoleCondition.DeserializeBoolRoleCondition( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.condition.BoolRoleCondition gen_to_be_invoked = (cfg.condition.BoolRoleCondition)translator.FastGetCSObj(L, 1);
