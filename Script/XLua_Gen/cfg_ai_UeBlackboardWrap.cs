...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiUeBlackboardWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.UeBlackboard);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "NotifyObserver", _g_get_NotifyObserver);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BlackboardKey", _g_get_BlackboardKey);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "KeyQuery", _g_get_KeyQuery);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeUeBlackboard", _m_DeserializeUeBlackboard_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.UeBlackboard.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.UeBlackboard(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.UeBlackboard constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeUeBlackboard_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.UeBlackboard.DeserializeUeBlackboard( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.UeBlackboard gen_to_be_invoked = (cfg.ai.UeBlackboard)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_NotifyObserver(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.UeBlackboard gen_to_be_invoked = (cfg.ai.UeBlackboard)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.NotifyObserver);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BlackboardKey(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.UeBlackboard gen_to_be_invoked = (cfg.ai.UeBlackboard)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.BlackboardKey);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_KeyQuery(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.UeBlackboard gen_to_be_invoked = (cfg.ai.UeBlackboard)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.KeyQuery);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
