...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgcostCostWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.cost.Cost);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeCost", _m_DeserializeCost_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.cost.Cost does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeCost_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.cost.Cost.DeserializeCost( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.cost.Cost gen_to_be_invoked = (cfg.cost.Cost)translator.FastGetCSObj(L, 1);
