...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDemoDynamicWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DemoDynamic);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDemoDynamic", _m_DeserializeDemoDynamic_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.test.DemoDynamic does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDemoDynamic_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DemoDynamic.DeserializeDemoDynamic( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoDynamic gen_to_be_invoked = (cfg.test.DemoDynamic)translator.FastGetCSObj(L, 1);
