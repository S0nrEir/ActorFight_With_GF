...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiBinaryOperatorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.BinaryOperator);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Oper", _g_get_Oper);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeBinaryOperator", _m_DeserializeBinaryOperator_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.ai.BinaryOperator.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.BinaryOperator(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.BinaryOperator constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeBinaryOperator_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.BinaryOperator.DeserializeBinaryOperator( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.BinaryOperator gen_to_be_invoked = (cfg.ai.BinaryOperator)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Oper(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.BinaryOperator gen_to_be_invoked = (cfg.ai.BinaryOperator)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Oper);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
