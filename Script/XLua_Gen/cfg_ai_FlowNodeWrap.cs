...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiFlowNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.FlowNode);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Decorators", _g_get_Decorators);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Services", _g_get_Services);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeFlowNode", _m_DeserializeFlowNode_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.FlowNode does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeFlowNode_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.FlowNode.DeserializeFlowNode( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.FlowNode gen_to_be_invoked = (cfg.ai.FlowNode)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Decorators(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.FlowNode gen_to_be_invoked = (cfg.ai.FlowNode)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Decorators);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Services(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.FlowNode gen_to_be_invoked = (cfg.ai.FlowNode)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Services);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
