...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgblueprintMethodWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.blueprint.Method);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeMethod", _m_DeserializeMethod_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.blueprint.Method does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeMethod_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.blueprint.Method.DeserializeMethod( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.blueprint.Method gen_to_be_invoked = (cfg.blueprint.Method)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_ReturnType(RealStatePtr L)
        {
		    try {
                ...
                cfg.blueprint.Method gen_to_be_invoked = (cfg.blueprint.Method)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.ReturnType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
