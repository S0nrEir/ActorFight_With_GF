...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgl10nPatchDemoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.l10n.PatchDemo);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializePatchDemo", _m_DeserializePatchDemo_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.l10n.PatchDemo.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.l10n.PatchDemo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.l10n.PatchDemo constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializePatchDemo_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.l10n.PatchDemo.DeserializePatchDemo( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.l10n.PatchDemo gen_to_be_invoked = (cfg.l10n.PatchDemo)translator.FastGetCSObj(L, 1);
