...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDateTimeRangeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DateTimeRange);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "StartTime_Millis", _g_get_StartTime_Millis);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "EndTime", _g_get_EndTime);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "EndTime_Millis", _g_get_EndTime_Millis);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDateTimeRange", _m_DeserializeDateTimeRange_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.test.DateTimeRange.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.DateTimeRange(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.DateTimeRange constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDateTimeRange_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DateTimeRange.DeserializeDateTimeRange( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DateTimeRange gen_to_be_invoked = (cfg.test.DateTimeRange)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_StartTime_Millis(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DateTimeRange gen_to_be_invoked = (cfg.test.DateTimeRange)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.StartTime_Millis);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_EndTime_Millis(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.test.DateTimeRange gen_to_be_invoked = (cfg.test.DateTimeRange)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.EndTime_Millis);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
