...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgconditionTimeRangeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.condition.TimeRange);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "DateTimeRange", _g_get_DateTimeRange);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeTimeRange", _m_DeserializeTimeRange_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.condition.TimeRange.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.condition.TimeRange(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.condition.TimeRange constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeTimeRange_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.condition.TimeRange.DeserializeTimeRange( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.condition.TimeRange gen_to_be_invoked = (cfg.condition.TimeRange)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_DateTimeRange(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.condition.TimeRange gen_to_be_invoked = (cfg.condition.TimeRange)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.DateTimeRange);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
