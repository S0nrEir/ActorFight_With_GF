...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTbTestStringWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TbTestString);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TbTestString(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TbTestString constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.test.TbTestString>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.test.TbTestString gen_to_be_invoked = (cfg.test.TbTestString)translator.FastGetCSObj(L, 1);
