...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.Node);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeNode", _m_DeserializeNode_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.Node does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeNode_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.Node.DeserializeNode( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.Node gen_to_be_invoked = (cfg.ai.Node)translator.FastGetCSObj(L, 1);
