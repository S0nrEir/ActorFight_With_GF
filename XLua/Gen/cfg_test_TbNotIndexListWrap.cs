...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestTbNotIndexListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.TbNotIndexList);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.test.TbNotIndexList(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.test.TbNotIndexList constructor!");
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.TbNotIndexList gen_to_be_invoked = (cfg.test.TbNotIndexList)translator.FastGetCSObj(L, 1);
