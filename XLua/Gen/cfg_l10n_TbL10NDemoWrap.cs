...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgl10nTbL10NDemoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.l10n.TbL10NDemo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.l10n.TbL10NDemo(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.l10n.TbL10NDemo constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.l10n.TbL10NDemo>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.l10n.TbL10NDemo gen_to_be_invoked = (cfg.l10n.TbL10NDemo)translator.FastGetCSObj(L, 1);
