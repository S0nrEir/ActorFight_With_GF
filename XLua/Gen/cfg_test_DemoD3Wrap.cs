...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgtestDemoD3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.test.DemoD3);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeDemoD3", _m_DeserializeDemoD3_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.test.DemoD3 does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeDemoD3_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.test.DemoD3.DeserializeDemoD3( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.test.DemoD3 gen_to_be_invoked = (cfg.test.DemoD3)translator.FastGetCSObj(L, 1);
