...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgconditionMinMaxLevelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.condition.MinMaxLevel);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "MinLevel", _g_get_MinLevel);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeMinMaxLevel", _m_DeserializeMinMaxLevel_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.condition.MinMaxLevel.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.condition.MinMaxLevel(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.condition.MinMaxLevel constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeMinMaxLevel_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.condition.MinMaxLevel.DeserializeMinMaxLevel( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.condition.MinMaxLevel gen_to_be_invoked = (cfg.condition.MinMaxLevel)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_MinLevel(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.condition.MinMaxLevel gen_to_be_invoked = (cfg.condition.MinMaxLevel)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.MinLevel);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
