...
namespace XLua.CSObjectWrap
{
    ...
    public class AquilaToolsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetTag", _m_SetTag_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetBitValue", _m_GetBitValue_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetBitValue", _m_SetBitValue_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetTag_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.GameObject>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetBitValue_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetBitValue_xlua_st_(RealStatePtr L)
        {
		    try {
