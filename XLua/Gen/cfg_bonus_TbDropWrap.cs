...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgbonusTbDropWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.bonus.TbDrop);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.bonus.TbDrop(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.bonus.TbDrop constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.bonus.TbDrop>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.bonus.TbDrop gen_to_be_invoked = (cfg.bonus.TbDrop)translator.FastGetCSObj(L, 1);
