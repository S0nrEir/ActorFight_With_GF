...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgblueprintTbClazzWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.blueprint.TbClazz);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.blueprint.TbClazz(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.blueprint.TbClazz constructor!");
        ...
        static int _m_GetOrDefault(RealStatePtr L)
        {
		    try {
                ...
                cfg.blueprint.TbClazz gen_to_be_invoked = (cfg.blueprint.TbClazz)translator.FastGetCSObj(L, 1);
