...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiKeyQueryOperatorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.KeyQueryOperator);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeKeyQueryOperator", _m_DeserializeKeyQueryOperator_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.KeyQueryOperator does not have a constructor!");
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeKeyQueryOperator_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.KeyQueryOperator.DeserializeKeyQueryOperator( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.KeyQueryOperator gen_to_be_invoked = (cfg.ai.KeyQueryOperator)translator.FastGetCSObj(L, 1);
