...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiTbBehaviorTreeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.TbBehaviorTree);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.ai.TbBehaviorTree(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.ai.TbBehaviorTree constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<cfg.ai.TbBehaviorTree>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					cfg.ai.TbBehaviorTree gen_to_be_invoked = (cfg.ai.TbBehaviorTree)translator.FastGetCSObj(L, 1);
