...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgitemChooseOneBonusWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.item.ChooseOneBonus);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "DropId", _g_get_DropId);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "DropId_Ref", _g_get_DropId_Ref);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "IsUnique", _g_get_IsUnique);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "DeserializeChooseOneBonus", _m_DeserializeChooseOneBonus_xlua_st_);
            
			
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "__ID__", cfg.item.ChooseOneBonus.__ID__);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.item.ChooseOneBonus(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.item.ChooseOneBonus constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeserializeChooseOneBonus_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.item.ChooseOneBonus.DeserializeChooseOneBonus( __buf );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetTypeId(RealStatePtr L)
        {
		    try {
                ...
                cfg.item.ChooseOneBonus gen_to_be_invoked = (cfg.item.ChooseOneBonus)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_DropId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.item.ChooseOneBonus gen_to_be_invoked = (cfg.item.ChooseOneBonus)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.DropId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_DropId_Ref(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.item.ChooseOneBonus gen_to_be_invoked = (cfg.item.ChooseOneBonus)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.DropId_Ref);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_IsUnique(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.item.ChooseOneBonus gen_to_be_invoked = (cfg.item.ChooseOneBonus)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.IsUnique);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
