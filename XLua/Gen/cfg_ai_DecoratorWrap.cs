...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgaiDecoratorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.ai.Decorator);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "FlowAbortMode", _g_get_FlowAbortMode);
        ...
        {
            return LuaAPI.luaL_error(L, "cfg.ai.Decorator does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    Bright.Serialization.ByteBuf __buf = (Bright.Serialization.ByteBuf)translator.GetObject(L, 1, typeof(Bright.Serialization.ByteBuf));
                        ...
                        var gen_ret = cfg.ai.Decorator.DeserializeDecorator( __buf );
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.ai.Decorator gen_to_be_invoked = (cfg.ai.Decorator)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_FlowAbortMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                cfg.ai.Decorator gen_to_be_invoked = (cfg.ai.Decorator)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.FlowAbortMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
