...
namespace XLua.CSObjectWrap
{
    ...
    public class cfgcommonTbGlobalConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(cfg.common.TbGlobalConfig);
			Utils.BeginObjectRegister(type, L, translator, 0, 2, 21, 0);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Bright.Serialization.ByteBuf>(L, 2))
				{
					...
					var gen_ret = new cfg.common.TbGlobalConfig(__buf);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to cfg.common.TbGlobalConfig constructor!");
        ...
        static int _m_Resolve(RealStatePtr L)
        {
		    try {
                ...
                cfg.common.TbGlobalConfig gen_to_be_invoked = (cfg.common.TbGlobalConfig)translator.FastGetCSObj(L, 1);
